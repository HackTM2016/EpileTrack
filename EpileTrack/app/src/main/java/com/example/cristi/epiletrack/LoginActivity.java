...
//            "cmot@:cvscvs", "obogdan@:cvs"
//    };

    private Vector<UserDetails> uDetails = new Vector<UserDetails>();
...
//        }
        ...
        uDetails.add(new UserDetails("", "test", "test@", "testtest", "0/0/0", "20160522" ));
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.buttonClose:
                Intent b = new Intent(LoginActivity.this, SplashScreenActivity.class);
                startActivity(b);
                break;
            default:
                break;
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            for (UserDetails credential : uDetails) {
                if (credential.email.equals(mEmail)) {
                    if( credential.pass.equals(mPassword))
                    {
                        currentUserDetails = credential;
                        return true;
                    }
                }
            }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                b.putExtra("email", currentUserDetails.email);
                b.putExtra("pass", currentUserDetails.pass);
                startActivity(b);
            } else {
