...
public class DashboardActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVisible = true;
        mControlsView = findViewById(R.id.seizureFreeDays);
        mContentView = findViewById(R.id.seizureFreeDays);
        ...
        ((TextView) mContentView).setText("hello " + email + " : " + pass);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.dashboardButton1:
//                Intent b = new Intent(DashboardActivity.this, LoginActivity.class);
//                startActivity(b);
                break;
            case R.id.dashboardButton2:
//                Intent a = new Intent(SplashScreenActivity.this, SignUpActivity.class);
//                startActivity(a);
                break;
            case R.id.dashboardButton3:
//                Intent a = new Intent(SplashScreenActivity.this, SignUpActivity.class);
//                startActivity(a);
                break;
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.cristi.epiletrack/http/host/path")
        );
